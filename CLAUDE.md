...
- [ ] Section 3: notebooks/02_eda.py + docs/figures/
- [ ] Section 4: src/features/engineer.py, notebooks/03_feature_engineering.py
- [ ] Section 5: src/models/geographic_clustering.py, notebooks/04_geographic_clustering.py
- [ ] Section 6: src/models/temporal_clustering.py, notebooks/05_temporal_clustering.py
- [ ] Section 7: src/models/dimensionality_reduction.py, notebooks/06_dimensionality_reduction.py
- [ ] Section 8: src/utils/helpers.py, scripts/run_full_pipeline.py, notebooks/07_mlflow_experiments.py
